...
use crate::{parser_lib_resilient::*, typort::empty_span};
...
macro_rules! T {
    [def] => { $crate::parser::TokenKind::DefKeyword };
    [let] => { $crate::parser::TokenKind::LetKeyword };
    [Type] => { $crate::parser::TokenKind::TypeKeyword };
    [this] => { $crate::parser::TokenKind::ThisKeyword };
    [_] => { $crate::parser::TokenKind::Hole };
    ['('] => { $crate::parser::TokenKind::LParen };
    [')'] => { $crate::parser::TokenKind::RParen };
    ['['] => { $crate::parser::TokenKind::LSquare };
    [']'] => { $crate::parser::TokenKind::RSquare };
    ['{'] => { $crate::parser::TokenKind::LCurly };
    ['}'] => { $crate::parser::TokenKind::RCurly };
    [.] => { $crate::parser::TokenKind::Dot };
    [,] => { $crate::parser::TokenKind::Comma };
    [=] => { $crate::parser::TokenKind::Eq };
    [;] => { $crate::parser::TokenKind::Semi };
    [:] => { $crate::parser::TokenKind::Colon };
    [->] => { $crate::parser::TokenKind::Arrow };
    [=>] => { $crate::parser::TokenKind::DoubleArrow };
