...
use super::{
    cxt::Cxt, empty_span, Env, Error, Infer, Lvl, PatternDetail, Tm, Val
};

use crate::parser::syntax::{Pattern, Raw};
    ...
    pub fn eval_aux(
        ...
        arms.iter()
            .filter_map(|(pattern, body)| match pattern {
                ...
                PatternDetail::Bind(name) => Some((body.clone(), cxt.prepend(heads.clone()))),
